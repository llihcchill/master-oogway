...
class understand_question:
    def __init__(self, sentence_array, nouns_and_verbs, question, final_quote):
        self.sentence_array = sentence_array
        self.nouns_and_verbs = nouns_and_verbs
        self.question = question
        self.final_quote = final_quote

    # prepare the sentence for comparison
    def prepare_sentence(self, sentence_array, nouns_and_verbs):
    ...
    def get_quote(self, question, final_quote):

        # define array to store the prepared question and run the function to prepare it
        final_question = []
        self.prepare_sentence(question, final_question)
        ...
        while continue_looking == True:
            ...
            for quote in api_quotes:
                ...
                final_single_quote = []
                self.prepare_sentence(single_quote, final_single_quote)
